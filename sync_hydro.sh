...
python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r hydro -d precise -a source -u file:/var/packages/ros-shadow-fixed/ubuntu -c
