...
python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r hydro -d precise -d quantal -d raring -a i386 -u file:/var/packages/ros-shadow-fixed/ubuntu -c
python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r hydro -d precise -d quantal -d raring -a amd64 -u file:/var/packages/ros-shadow-fixed/ubuntu -c
python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r hydro -d precise -d quantal -d raring -a source -u file:/var/packages/ros-shadow-fixed/ubuntu -c
...
# python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r hydro -d quantal -a source -u file:/var/packages/ros-shadow-fixed/ubuntu -c
...
# python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r hydro -d raring -a source -u file:/var/packages/ros-shadow-fixed/ubuntu -c
