...
python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r fuerte -d lucid -a source -u file:/var/packages/ros-shadow-fixed/ubuntu -c
...
python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r fuerte -d oneiric -a source -u file:/var/packages/ros-shadow-fixed/ubuntu -c
...
python /home/rosbuild/reprepro_updater/scripts/prepare_sync.py /var/packages/ros/ubuntu -r fuerte -d precise -a source -u file:/var/packages/ros-shadow-fixed/ubuntu -c
